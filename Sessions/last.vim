...
silent only
silent tabonly
cd ~/Dropbox/Personal/Files
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +4 11-6-22.txt
badd +96 ~/Dropbox/Personal/Files/vim_cheatsheet.txt
badd +58 ~/.vim/vimrc
argglobal
%argdel
$argadd 11-6-22.txt
edit ~/.vim/vimrc
argglobal
balt ~/Dropbox/Personal/Files/vim_cheatsheet.txt
...
silent! normal! zE
let &fdl = &fdl
let s:l = 58 - ((25 * winheight(0) + 26) / 52)
